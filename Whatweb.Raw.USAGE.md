...
Latest Release: v0.5.5.12 August 18th, 2021
...
HTTP OPTIONS:
  --user-agent, -U=AGENT Identify as AGENT instead of WhatWeb/0.5.5.12.
...
HELP & MISCELLANEOUS:
  ...
  --version               Display version information. (WhatWeb 0.5.5.12).
...
- Version 0.5.5.12 Released August 18th, 2021
